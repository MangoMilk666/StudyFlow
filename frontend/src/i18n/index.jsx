...
const translations = {
  en: {
    ...
    focus: {
      ...
      modeClassic: 'Classic mode (25 min)',
      modeCustom: (minutes) => `Custom mode (${minutes || 0} min)`,
      customMinutes: 'Custom minutes',
      apply: 'Apply',
      stopBeforeAdjust: 'Please stop the timer before adjusting minutes.',
      invalidMinutes: 'Please enter a valid minutes value.',
    ...
    settings: {
      ...
      focusTimerTitle: 'Focus Timer Mode',
      focusTimerHint: 'Switch between classic 25-minute Pomodoro and a custom countdown.',
      focusTimerClassic: 'Classic (25 min)',
      focusTimerCustom: 'Custom',
      focusTimerMinutesLabel: 'Custom minutes',
      focusTimerInvalidMinutes: 'Custom minutes must be between 1 and 240.',
      focusTimerInvalidMode: 'Invalid focus timer mode.',
  ...
  zh: {
    ...
    focus: {
      ...
      modeClassic: '经典模式（25 分钟）',
      modeCustom: (minutes) => `自定义模式（${minutes || 0} 分钟）`,
      customMinutes: '自定义分钟数',
      apply: '应用',
      stopBeforeAdjust: '请先停止计时，再调整分钟数。',
    ...
    settings: {
      ...
      modules: '模块管理',
      aiConfig: 'AI 设置',
      focusTimerTitle: '专注计时模式',
      focusTimerHint: '经典模式为 25 分钟番茄钟；自定义模式可使用自定义倒计时分钟数。',
      focusTimerClassic: '经典模式（25 分钟）',
      focusTimerCustom: '自定义模式',
      focusTimerMinutesLabel: '自定义分钟数',
      focusTimerInvalidMinutes: '自定义分钟数需在 1 到 240 之间。',
      focusTimerInvalidMode: '专注计时模式无效。',
      changeEmail: '修改邮箱',
